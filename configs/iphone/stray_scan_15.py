...
scene_name = "stray_0403_sub15_all"  # Scan Name
num_frames = 1124  # Number of frames to use (-1 for all)
...
downscale_factor = 1.0  # Downscale for tracking (high res is slow)
...
config = dict(
    ...
    wandb=dict(
        ...
        name=f"StrayScan_{scene_name}_{seed}",
        save_qual=False,
        eval_save_qual=True,
    ),
    data=dict(
