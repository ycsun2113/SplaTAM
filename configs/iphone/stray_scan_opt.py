...
scene_name = "stray_scan_02_sub5_all"
params_path = f"./experiments/iphone/{scene_name}/stray_scan/params.npz"

group_name = "iPhone_StrayScan"
run_name = f"{scene_name}_post_opt"
